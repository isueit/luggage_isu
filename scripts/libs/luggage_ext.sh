...
install_luggage_features() {
    ...
    luggage_news_solr luggage_placeholder luggage_resources luggage_resources_solr luggage_roles luggage_roles_solr luggage_seo luggage_solr luggage_ui luggage_vars
}

    #luggage_people 
    #luggage_people_expertise 
    #luggage_people_solr 
    #luggage_projects 
    #luggage_biblio
